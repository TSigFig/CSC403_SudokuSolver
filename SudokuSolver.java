...
public class SudokuSolver {
    ...
    private final int BOX_SIZE = 3; // Length and Width of the size of a box set
    private final int BOARD_SIZE = BOX_SIZE * BOX_SIZE; // Length and Width of the size of a board
